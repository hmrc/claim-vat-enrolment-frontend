...
//case object WebchatEnabled extends FeatureSwitch {
//  override val configName: String = "feature-switch.webchat-enabled"
//  override val displayName: String = "Enable Webchat"
//}