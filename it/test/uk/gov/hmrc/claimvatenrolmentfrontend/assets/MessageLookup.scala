...
object MessageLookup {
  ...
  object CaptureVatApplicationNumber {
    ...
    val line_2 =
      "The VAT application number was displayed on the screen after an application for VAT registration was made. It was also emailed and will be on the VAT registration letter we sent in the post."
  ...
  object CaptureLastMonthSubmitted {
    ...
    val panelFirstText =
      "You submit your VAT Return quarterly (every three months). In the ‘accounting period’ January to March, the last month in that ‘accounting period’ is March. You must therefore select March."
    val panelSecondHeading = "Latest VAT accounting period, example 2"
    val panelSecondText =
      "If you submit your VAT Return monthly, the last accounting period you ‘submitted for’ was January. You must select January."
  ...
  object KnownFactsMismatch {
    ...
    val ver2Line_1 =
      "The details you provided are not the same as those that we have on record. They must match exactly the details on the VAT registration confirmation letter that we sent by post."
  ...
  object DifferentVatNumbersError {
    ...
    val line_1 =
      "The VAT registration number you have provided does not match exactly the number previously used. For security, this session must be restarted."
  ...
  object KnownFactsMismatchWithin24hrs {
    ...
    val line_1 =
      "In the last 24 hours, business details were provided that did not match exactly those that we have on record. For security, we have locked access for 24 hours from the last failed attempt."
    val line_2 =
      "Before your next attempt, check you have the correct information. This can be found on your latest VAT Return or the VAT registration confirmation letter we sent by post."
  ...
  object ThirdAttemptLockout {
    ...
    val line_1 =
      "The details you provided must match exactly those that we have on record. Before your next attempt, check you have the correct information. This can be found on your latest VAT Return or the VAT registration confirmation letter we sent by post."
