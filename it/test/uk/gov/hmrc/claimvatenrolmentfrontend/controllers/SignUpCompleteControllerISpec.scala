...
import uk.gov.hmrc.claimvatenrolmentfrontend.views.SignUpCompleteViewTests

class SignUpCompleteControllerISpec extends ComponentSpecHelper with SignUpCompleteViewTests with AuthStub {
