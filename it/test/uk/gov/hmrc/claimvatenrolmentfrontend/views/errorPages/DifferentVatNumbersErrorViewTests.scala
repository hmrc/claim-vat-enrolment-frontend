...
import uk.gov.hmrc.claimvatenrolmentfrontend.assets.MessageLookup.{Header, DifferentVatNumbersError => messages}
import uk.gov.hmrc.claimvatenrolmentfrontend.utils.{ComponentSpecHelper, ViewSpecHelper}

trait DifferentVatNumbersErrorViewTests extends ViewSpecHelper {
  this: ComponentSpecHelper =>

  def testDifferentVatNumbersErrorView(result: => WSResponse): Unit = {
